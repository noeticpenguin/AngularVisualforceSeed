/*! angular-ladda 0.1.5 */ ! function() {
	"use strict";
	angular.module("angular-ladda", []).directive("ladda", ["$compile",
		function(a) {
			return {
				restrict: "A",
				link: function(b, c, d) {
					c.addClass("ladda-button"), angular.isUndefined(c.attr("data-style")) && c.attr("data-style", "zoom-in");
